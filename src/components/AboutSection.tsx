// app/about/page.tsx  (Next.js App Router)  •  TailwindCSS
  ...
  return (
    <main className="relative">
      <section className="mx-auto w-full max-w-7xl px-6 py-12 md:py-14">
        {/* --- Top row: heading + blurb (left) and button (right) --- */}
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-[15px] leading-7 text-gray-600">
              At 1 Global Enterprises, we take pride in our values — service, integrity, and
              excellence.
            </p>
          </div>
          ...
          <a
            href="#learn-more"
            className="inline-flex w-max items-center gap-2 self-start rounded-lg bg-blue-500 px-5 py-3 text-white shadow transition hover:bg-blue-600 sm:self-auto"
          >
            Learn More
            <svg
              className="h-4 w-4"
        ...
        {/* --- Bottom row: left text 2×2 + right images 2×2 --- */}
        <div className="mt-10 grid grid-cols-1 gap-10 md:grid-cols-2">
          ...
          {/* Right: 2×2 images — keep sizes like the screenshot */}
